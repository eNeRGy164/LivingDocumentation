...
namespace LivingDocumentation.Uml
{
    public static partial class StringBuilderExtensions
    {
        ...
        public static void InterfaceStart(this StringBuilder stringBuilder, string name, string displayName = null, string stereotype = null, CustomSpot? customSpot = null, string backgroundColor = null, string generics = null)
        {
            ...
            stringBuilder.Append(Constant.Interface);
            ...
            stringBuilder.Append(Constant.InterfaceStart);
